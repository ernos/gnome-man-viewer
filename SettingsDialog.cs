...
{
    public static (ResponseType response, bool enableHelpFallback, bool useSingleClick) ShowDialog(Window parent)
    {
        ...
        dialog.Hide();
        return (response, enableHelpFallback, useSingleClick);
    }
}
